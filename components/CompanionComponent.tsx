...
export default function CompanionComponent({ companionId, subject, name, userName, userImage, topic, style, voice }: CompanionComponentProps) {
    ...
    const handleCall = () => {
        ...
        // @ts-expect-error
        vapi.start(configureAssistant(voice, style), assistandOverrides);
    }
